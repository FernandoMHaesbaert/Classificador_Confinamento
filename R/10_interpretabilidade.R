...
# =========================================================
# Objetivo:
# Gerar visualizações interpretáveis e métricas de explicabilidade do modelo.
#
# Inclui:
...
interpretar_modelo <- function(
      ...
      # ===================================================
      OR <- exp(coeficientes)
      IC_inf <- exp(modelo_firth$ci.lower[idx])
      IC_sup <- exp(modelo_firth$ci.upper[idx])
      ...
      # ===================================================
      message("\n========== INTERPRETABILIDADE ==========")
      message(paste("Variáveis interpretadas:",
                  nrow(
                        tabela_interpretacao
                  )
            )
      ...
      return(
            list(
                  tabela = tabela_interpretacao,
                  explainability = explainability,
                  forest_plot = forest_plot,
                  grafico_importancia = grafico_importancia,
                  or_plot = or_plot,
                  curvas_marginais = curvas_marginais,
                  bootstrap = resumo_bootstrap
            )
      )
}