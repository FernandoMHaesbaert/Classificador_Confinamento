...
# =========================================================
# Objetivo:
# Avaliar robustez estrutural das variáveis
# via Bootstrap Stability Selection utilizando
# Elastic Net penalizado.
#
# Estratégia:
...
#
# IMPORTANTE:
# Este módulo DEFINE as variáveis
# que irão para o modelo final.
# =========================================================
